...
PROMPTS["DEFAULT_ENTITY_TYPES"] = ["CustomsTariff", "TariffChapter", "ClassificationRule", "HSCode", "CIQCode", "Product", "Alias", "Component", "Material", "Procedure", "Function", "Threshold", "Usage", "Range", "Specification", "Feature", "Taxation", "UOM", "DeclarationElement", "CustomsRegulation", "CIQType", "EnergyEfficiency", "CustomsDecision", "other"]
